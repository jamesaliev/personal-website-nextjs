        ...
        <section className={styles.section}>
          <h1 className={styles.heading}>technologies</h1>
            <div className={styles.technologiesContainer}>
              ...
              <Image src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/threejs/threejs-original.svg" height={60} width={60} alt="Three.js"/>
              ...
              <Image src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/yaml/yaml-original.svg" height={60} width={60} alt="YAML"/>
